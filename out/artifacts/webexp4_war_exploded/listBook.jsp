...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" pageEncoding="UTF-8" import="java.util.*,bean.Book" isELIgnored="false" %>
        ...
        <div class="bookListDiv">
            ...
            <div class="allBook">
                <table class="table">
                    ...
                    <tr>
                        <td><a href="?start=${pre}">上一页</a></td>
                        <td><a href="?start=${next}">下一页</a></td>
                        <td><a href="?start=0">首页</a></td>
                        <td><a href="?start=${last}">尾页</a></td>
                    </tr>
                </table>
            </div>
        </div>
