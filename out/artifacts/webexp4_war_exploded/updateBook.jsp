...
<div class="updateBookPage">
    ...
    <div class="actionMenuAndAddBookDiv">
        ...
        <div class="addUnitDiv">
            <div class="addBook">更新书本信息</div>
            <form action="updateBook" method="post">
                <div class="specialDiv"><span>书本ID</span><input type="text" name="id" class="form-control bid"  value="<%=request.getAttribute("bid")%>"></div>
                <div><span>书本名称</span><input type="text" name="name" class="form-control"  value="<%=request.getAttribute("name")%>"></div>
                <span>书本类别</span><input type="text" name="kind" class="form-control"  value="<%=request.getAttribute("kind")%>">
                <span>入库时间</span><input type="text" name="time" class="form-control btime"  value="<%=request.getAttribute("time")%>">
